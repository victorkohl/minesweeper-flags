...
var GameError = function (_ExtendableError) {
  _inherits(GameError, _ExtendableError);

  function GameError(msg) {
    _classCallCheck(this, GameError);

    return _possibleConstructorReturn(this, (GameError.__proto__ || Object.getPrototypeOf(GameError)).call(this, msg));
  }
